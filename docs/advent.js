...
var ASM_CONSTS = {
 ...
 150812: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 150895: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 150964: () => { return window.innerWidth; },  
 150994: () => { return window.innerHeight; }
};
